...
/**
 * This class helps with serializing objects to a string to send through a
 * socket as UTF. It also deserialises strings to objects again. This class is
 * needed for the client and the server Taken from
