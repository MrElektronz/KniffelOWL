...
/**
 * This class checks 50 times per second for a lobby or game update
 * 
 * @author KBeck
 *
 */
	...
	public void run() {
		while (running && !client.getSocket().isClosed()) {
			...
			if (command.equals("!LobbyUpdate")) {
				...
				// !GameStart;SerializedObjectWhichContains:All Players,All Stats,current
				// player,active dice numbers, bank dice numbers
