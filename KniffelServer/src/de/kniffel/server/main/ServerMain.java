...
public class ServerMain {
	 ...
	 * 	1. loads data from the config
	 * 	2. creates the database if it doesn't exist already
	 * 	3. sets up the SessionManager
	 * 	4. starts multiple threads which are the "core" of the server
